...
using ColorizedImageEncoder.Properties;
...
class FirefoxMainTabControl : TabControl
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        for (int i = 0; i <= TabPages.Count - 1; i++)
        {
            ...
            if (i == 0)
            {
                G.DrawImage(Resources.string_encoding, new Rectangle(TabRect.X + 19, TabRect.Y + ((TabRect.Height / 2) - 10), 22, 22));
            }
            else if (i == 1)
            {
                G.DrawImage(Resources.string_file_decoding, new Rectangle(TabRect.X + 19, TabRect.Y + ((TabRect.Height / 2) - 10), 22, 22));
            }
            else if (i == 2)
            {
                G.DrawImage(Resources.file_encoding, new Rectangle(TabRect.X + 19, TabRect.Y + ((TabRect.Height / 2) - 10), 22, 22));
            }
            else if (i == 3)
            {
                G.DrawImage(Resources.string_file_decoding, new Rectangle(TabRect.X + 19, TabRect.Y + ((TabRect.Height / 2) - 10), 22, 22));
